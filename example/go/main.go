...
import (
	...
	"github.com/severgroup-tt/protoc-gen-twirp_dart/example/go/config/model"
	config_service "github.com/severgroup-tt/protoc-gen-twirp_dart/example/go/config/service"
